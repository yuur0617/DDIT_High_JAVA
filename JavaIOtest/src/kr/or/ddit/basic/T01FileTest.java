	...
	public static void main(String[] args) throws IOException {
		/*
			...
			1. new File(String 파일 또는 경로명)
				=> 디렉토리와 디렉토리 사이 또는 디렉토리와 파일명 사이의 구분문자는 '\'를 사용하거나 '/'를 사용할수 있다.
		*/
		...
		*/
		...
		/*
			...
			1. mkdir() 	=> File객체의 경로 중 마지막위치의 디렉토릐를 만든다.
		...
		*/
		File file5 = new File("d:/D_Oter/연습용");
		if(file5.mkdir()) {
		...
		File file6 = new File("d:/D_Oter/test/java/scr");
		if(file6.mkdir()) {
